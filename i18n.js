...
const TRANSLATIONS = {
  fr: {
    ...
    "settings.resetAllHint": "Efface la progression, les réglages, les badges et les Shiny débloqués. Irréversible.",
    "settings.resetAll": "🗑️ Tout réinitialiser",
    "settings.resetAllConfirm": "Tout réinitialiser ? Cette action effacera définitivement ta progression, tes réglages, tes badges et tes Shiny débloqués.",
  ...
  en: {
    ...
    "settings.resetAllHint": "Erases progress, settings, badges, and unlocked Shinies. Irreversible.",
    "settings.resetAll": "🗑️ Reset everything",
    "settings.resetAllConfirm": "Reset everything? This will permanently erase your progress, settings, badges, and unlocked Shinies.",
  ...
  es: {
    ...
    "settings.resetAllHint": "Borra el progreso, los ajustes, las insignias y los Shiny desbloqueados. Es irreversible.",
    "settings.resetAll": "🗑️ Restablecer todo",
    "settings.resetAllConfirm": "¿Restablecer todo? Esto borrará permanentemente tu progreso, tus ajustes, tus insignias y tus Shiny desbloqueados.",
  ...
  de: {
    ...
    "settings.resetAllHint": "Löscht Fortschritt, Einstellungen, Abzeichen und freigeschaltete Shinys. Unwiderruflich.",
    "settings.resetAll": "🗑️ Alles zurücksetzen",
    "settings.resetAllConfirm": "Alles zurücksetzen? Dies löscht dauerhaft deinen Fortschritt, deine Einstellungen, deine Abzeichen und deine freigeschalteten Shinys.",
